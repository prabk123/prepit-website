...
| **Performance/Analytics** | Helps us see where users get stuck on the website or in the app so we can fix bugs and improve the experience (e.g., PostHog). | **Optional** |
...
* **Analytics (PostHog):** Helps us understand website usage, session replays, and product performance on the PrepIt website and app.
